...
public class Kategori {
    ...
    @FXML
    private Label tambahkatlbl, editkatlbl, hapuskatlbl, profillbl, tambahdatalbl, keluarlbl, katlbl;
    ...
    public void profil(){
        try {
            ...
            rs = st.executeQuery("Select * from user where nama_user='" + this.namalbl + "'");
            System.out.println("sampe sini");


            hm.setemail(rs.getString("email"));
            hm.setjeniskel(rs.getString("Jenis_kelamin"));
            hm.setnamalengkap(this.namalbl);
